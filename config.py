...
DEFAULT_CF_SUBMISSION_WORKER_COUNT: int = 1
DEFAULT_DATA_ASSEMBLY_WORKER_COUNT: int = 1
DEFAULT_FUZZ_GENERATOR_WORKER_COUNT: int = 2
...
MAX_CF_SUBMISSION_WORKERS: int = 2
MAX_DATA_ASSEMBLY_WORKERS: int = 2
MAX_FUZZ_GENERATOR_WORKERS: int = 4


# --- API & Batching Controls ---
DEFAULT_ANALYSIS_BATCH_SIZE: int = 5
DEFAULT_FUZZ_BATCH_SIZE: int = 5
